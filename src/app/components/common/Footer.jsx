...
const Footer = () => {
  return (
    ...
    <footer className="mil-dark-bg">
        ...
        <div className="mil-footer-content mil-p-120-90">
          <Row className='justify-content-between align-items-center'>
            <Col xl={4} className='mil-mb-30'>
              <Image src={Logo} alt="" className="mil-logo mil-mb-30" style={{ width: "140px" }} />
            ...
            <Col xl={7} className='mil-mt-60-adapt'>
              <Row>
                <Col lg={7} className='mil-mb-30'>
                  <h3 className="mil-light mil-up-font mil-mb-30">Join The <span className="mil-accent">ITSulu</span> <br />Experience</h3>
                  <p className="mil-light-soft">Lorem ipsum dolor sit amet, consectetuer<br /> adipiscing elit, sed diam nonummy.</p>
                </Col>
      ...
      </Container>   <div className="mil-footer-bottom">
